...
def exportPNG8(image, layer, transparent):
    ...
    if okayToExport == True:
        ...
        if transparent == 0:
            # Not transparent
            # Export the image
            MMBGP.exportTextureMM(image, layer, xcfPath, ".png", indexColors=256, subFolder="PNG8")
        else:
            # Transparent
            # Export the image
            MMBGP.exportTextureMM(image, layer, xcfPath, ".png", transparent=True, subFolder="PNG8", alphaIndexed=True, alphaIndexColors=256)
