...
by BaconWizard17
## Export to PNG4
This plugin exports a texture to PNG4 format
...
3. The .xcf will be saved, and then the image will be flattened, indexed to 16 colors, and then exported as a .png to a `PNG4` folder in the same location as the .xcf file.
