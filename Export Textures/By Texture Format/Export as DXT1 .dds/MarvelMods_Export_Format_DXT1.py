...
def ExportDXT1(image, layer, alchemy_version, export_rgb, export_bgr):
    ...
    if okay_to_export == True:
        ...
        if export_rgb == 1:
            ...
            mmbgp.ExportTextureMM(image, layer, xcf_path, '.dds')
        ...
        if export_bgr == 1:
            ...
            if alchemy_version == 0:
                ...
                mmbgp.ExportTextureMM(image, layer, xcf_path, '.dds', file_name_prefix = prefix, rgb_bgr = True)
            else:
                # Alchemy 5.
                # Display the warning.
...
register(
    ...
    'Exports a texture in DXT1 format as a .dds.',
    'Exports a texture in DXT1 format as a .dds.',
    'BaconWizard17',
    'BaconWizard17',
    'September 2025',
