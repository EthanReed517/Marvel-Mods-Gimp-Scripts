...
register(
    ...
    [
        ...
        (PF_OPTION, "game", "Game:", 0, ["XML1/XML2","MUA1"]),
        (PF_OPTION, "console", "Console:", 0, ["All (Except PSP)","PC Only","PSP Only"]),
        (PF_OPTION, "asset", "Asset Type:", 0, ["Loading Screen","Comic Cover","Concept Art"])
    ],
    [],
    exportLoading,
