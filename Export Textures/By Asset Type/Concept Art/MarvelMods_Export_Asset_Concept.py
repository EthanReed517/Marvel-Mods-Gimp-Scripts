...
# INFORMATION #
# ########### #
# GIMP plugin to export a concept art texture
...
def exportConcept(image, layer, console, alchemyVersion):
    MMET.exportConceptLoading(image, layer, console, alchemyVersion, "concept")
...
register(
    "python_fu_marvelmods_export_asset_concept",
    "Creates and exports a concept art texture in multiple formats.\n\nCheck the README.md file included with the\ndownload for more clarity on the options.",
    "Creates and exports a concept art texture in multiple formats.",
    "BaconWizard17",
    "BaconWizard17",
    "December 2024",
