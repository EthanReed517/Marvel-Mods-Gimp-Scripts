...
# INFORMATION #
# ########### #
# GIMP plugin to convert an image to PNG4 format by flattening the image and indexing to 16 colors.
...
register(
    "python_fu_marvelmods_utilities_convert_png4",
    "Flatten image, convert to indexed palette with 16 colors.",
    "Flatten image, convert to indexed palette with 16 colors.",
    "BaconWizard17",
    "BaconWizard17",
    "January 2023",
